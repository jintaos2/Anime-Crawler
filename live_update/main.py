...
if __name__ == "__main__":
    ...
    message_file = os.path.join(os.path.expanduser("~"), 'Desktop', 'massage_sync', 'log.txt')
    ...
    while True:
        ...
        for i_ in source_list:
            try:
                new_items = i_()
                subscribe.update_message(new_items, message_file)
                subscribe.download(message_file)
